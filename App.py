...
# RXTRACK: EXECUTIVE DASHBOARD (FINAL ISOLATED v9.24)
# Architecture: Tri-Table Strategy (Events | Config | Pharmacy)
# Fixes: 
#   1. Tab 9 (Reconciliation): Expanded Narcotic Filter list.
#      - Added Vimpat, Lyrica, Librium, Klonopin to exclusion list.
#   2. Previous fixes preserved.
###############################################
    ...
    if not df.empty and not df_pharm.empty:
        ...
        if filter_controlled:
            narc_terms = ["OXYCODONE", "MORPHINE", "FENTANYL", "HYDROMORPHONE", "HYDROCODONE", "LORAZEPAM", 
                          ...
                          "TRAMADOL", "ZOLPIDEM", "PHENOBARBITAL", "BUPRENORPHINE", "LACOSAMIDE", 
                          "VIMPAT", "PREGABALIN", "LYRICA", "CHLORDIAZEPOXIDE", "LIBRIUM", "CLONAZEPAM", "KLONOPIN"]
